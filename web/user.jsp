...
<html>
    ...
    <%
            ...
            session.setAttribute("Topic", "general");
        ...
        try {
                ...
                String query1 = "SELECT * FROM `generalquestions`";
        ...
        for(int i = 0; i < Arrsize; i++){    
                ...
                String insertQuery = "SELECT * FROM `generalreplies` WHERE QID = ? ";
        ...
        out.print("<div class='card bg-dark text-white' style='margin:5px;'>"+
            ...
            "<div class='card-footer'>"+
                ...
                "<div id='reply' class='collapse'>"+
                    "<form action='GeneralReplies' method='post' class='input-group mb-3'>"+
                ...
                "<div id='ask' class='collapse'>"+ 
                        "<form action='GeneralQs' method='post' class='input-group mb-3'>"+
